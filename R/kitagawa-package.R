...
#' gives the amplitude and phase response we wish to calculate; this 
#' was originally presented 
#' by Hsieh et al (1987), and subsequently adapted by
#' Kitagawa et al (2011) for the case of a sealed well.
#' The model is applicable to any quasi-static process involving harmonic, 
#' volumetric
#' strain of an aquifer (e.g. passing Rayleigh waves, or changes in the Earth's
#' tidal potential)
#' 
#' In practice, however,
#' the presence of permeable fractures can violate the
...
#' @aliases kitagawa
#' @title Calculate theoretical spectral response for high-frequency borehole strain and fluid-pressure measurements
#' 
...
#'
#' @seealso \code{\link{well_response}}, \code{\link{sensing_volume}}, \code{\link{kitplot}}
#'  
NULL
#
