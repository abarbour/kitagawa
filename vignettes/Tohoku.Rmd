...
stations in the [Network of the Americas(https://www.unavco.org/projects/major-projects/nota/nota.html)^[previously known as the [Plate Boundary Observatory](https://www.unavco.org/unavco.html)]
...
#!order_matters
class(toh.dat)
toh_to_pspec <- toh.dat[,c('output','input')]
