...
\hlstd{WR} \hlkwb{<-} \hlkwd{well_response}\hlstd{(omega,} \hlkwc{T.} \hlstd{= T.,} \hlkwc{S.} \hlstd{= S.,} \hlkwc{Vw.} \hlstd{= Vw.,} \hlkwc{Rs.} \hlstd{= Rs.,} \hlkwc{Ku.} \hlstd{= Ku.,}
    \hlkwc{B.} \hlstd{= B.,} \hlkwc{Avs} \hlstd{=} \hlnum{1}\hlstd{,} \hlkwc{Aw} \hlstd{=} \hlnum{1}\hlstd{)}  \hlcom{#4.8)}
\hlstd{rsp} \hlkwb{<-} \hlstd{WR[[}\hlstr{"Response"}\hlstd{]]}
\hlcom{# Amplitude}
\hlstd{kGain} \hlkwb{<-} \hlstd{rsp[,} \hlnum{2}\hlstd{]} \hlopt{*} \hlstd{rhog}\hlopt{/}\hlstd{Ku.}\hlopt{/}\hlstd{B.}
\hlcom{# Phase}
\hlstd{kPhs} \hlkwb{<-} \hlstd{rsp[,} \hlnum{3}\hlstd{]}  \hlcom{# will wrap to -pi/pi}
